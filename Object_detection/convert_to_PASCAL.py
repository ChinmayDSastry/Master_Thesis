#This script converts labels in csv to XML format in PASCAL VOC
...
save_root2 = "xml_stylegan_augmented2" # enter the directory where the xmls should be generated
...
with open('augmented_sailboat_stylegan2.csv', 'r', encoding='utf-8') as f_input_csv: # the csv which contains the bounding box and labels
